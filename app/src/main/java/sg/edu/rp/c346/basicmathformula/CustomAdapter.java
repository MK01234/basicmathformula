...
class CustomAdapter extends ArrayAdapter {
        ...
        int layout_id;
        ArrayList<FormulaList> mathlist;
    ...
    public CustomAdapter(@NonNull Context context, int resource, @NonNull ArrayList<FormulaList> objects) {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            TextView tvend = rowView.findViewById(R.id.tvend);
            FormulaList currentItem = mathlist.get(position);
            tvname.setText(currentItem.getMath());
            tvdate.setText(currentItem.getFormula());
            tvend.setText(currentItem.getType());
            return rowView;
